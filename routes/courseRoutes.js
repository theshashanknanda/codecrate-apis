...
const {createCourse, getInstructorCourses, getAllCourses, getStudentCourses, updateCourseStatus, updateCourse, deleteCourse, addCourseToStudent, addCompletedLecture, codeRunnerController} = require('../controllers/courseController')
...
router.post('/run-code', codeRunnerController)
